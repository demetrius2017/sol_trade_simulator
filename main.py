...
model, scaler, df_ml = train_trend_predictor(df)
X = df_ml[['EMA12', 'EMA26', 'MACD', 'RSI', 'Volatility', 'Return']]

# Подготовка признаков на каждый тик
...
# Симуляция
from grid_simulator_with_ml_hedged import SimpleGridSimulator as SimpleGridSimulator  # Final version
